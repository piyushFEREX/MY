  ...
  return (
    <div
      ...
      <div className='h-full w-full rounded-2xl glassmorphism p-0'>
        ...
        {/* //text on 90deg rotation */}
  {/* next button  */}
       <NeumorphicTile light={0} visible={rotation > 135 && rotation < 225 ? true : false} theme={theme} size={200}  padding={80}  rotation={MobileScreen ? 0 : 180} order={order}/>
        {/* next button  */}
        {/* previous button  */}
        <NeumorphicTile light={2} prev={true} visible={rotation > 315 && rotation < 405 ? true : false} theme={theme} size={200}  padding={80}  rotation={MobileScreen ? 0 : 180} order={order}/>
        {/* previous button  */}
